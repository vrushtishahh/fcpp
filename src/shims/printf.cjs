// Browser-safe printf implementation without Node.js stream or util dependencies
...
function printf(){
  var args = Array.prototype.slice.call(arguments),
    stream, format;
  if(args[0] && typeof args[0] === 'object' && typeof args[0].write === 'function'){
    stream = args.shift();
  }
  format = args.shift();
